import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`iblCdfyPixelShader`,n=`varying vUV : vec2f;
...
fragmentOutputs.color= vec4f(cdfy,0.0,0.0,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);const r={name:t,shader:n};export{r as b};