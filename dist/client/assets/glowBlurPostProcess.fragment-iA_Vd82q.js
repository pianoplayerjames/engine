import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`glowBlurPostProcessPixelShader`,n=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
gl_FragColor=baseColor;}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);const r={name:t,shader:n};export{r as b};