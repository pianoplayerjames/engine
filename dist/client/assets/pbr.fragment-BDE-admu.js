...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ee);const n=`pbrFragmentExtraDeclaration`,r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=r);const i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);const o=`pbrFragmentSamplersDeclaration`,te=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=te);const s=`subSurfaceScatteringFunctions`,c=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);const l=`pbrHelperFunctions`,u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);const d=`pbrDirectLightingSetupFunctions`,ne=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ne);const f=`pbrDirectLightingFalloffFunctions`,re=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=re);const p=`pbrDirectLightingFunctions`,ie=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ie);const m=`pbrIBLFunctions`,h=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);const g=`pbrBlockAlbedoOpacity`,_=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);const v=`pbrBlockReflectivity`,y=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const b=`pbrBlockAmbientOcclusion`,x=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);const S=`pbrBlockAlphaFresnel`,ae=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ae);const C=`pbrBlockAnisotropic`,oe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=oe);const w=`pbrBlockReflection`,se=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=se);const T=`pbrBlockSheen`,ce=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ce);const E=`pbrBlockClearcoat`,le=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=le);const D=`pbrBlockIridescence`,O=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);const k=`pbrBlockSubSurface`,A=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);const j=`pbrBlockNormalGeometric`,M=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);const N=`pbrBlockNormalFinal`,P=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);const F=`pbrBlockLightmapInit`,I=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);const L=`pbrBlockGeometryInfo`,R=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);const z=`pbrBlockReflectance0`,B=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);const V=`pbrBlockReflectance`,H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);const U=`pbrBlockDirectLighting`,W=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);const G=`pbrBlockFinalLitComponents`,ue=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ue);const K=`pbrBlockFinalUnlitComponents`,de=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=de);const q=`pbrBlockFinalColorComposition`,J=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);const Y=`pbrBlockImageProcessing`,fe=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=fe);const X=`pbrBlockPrePass`,pe=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=pe);const Z=`pbrDebug`,me=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=me);const Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);const he={name:Q,shader:$};export{he as b};