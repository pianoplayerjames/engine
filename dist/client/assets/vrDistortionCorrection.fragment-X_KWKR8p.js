import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`vrDistortionCorrectionPixelShader`,n=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);const r={name:t,shader:n};export{r as b};