import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`iblCdfxPixelShader`,n=`#define PI 3.1415927
...
fragmentOutputs.color= vec4f( vec3f(cdfx),1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);const r={name:t,shader:n};export{r as b};