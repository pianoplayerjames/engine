import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`bayerDitherFunctions`,n=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);const r=`shadowMapFragmentExtraDeclaration`,i=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);const a=`shadowMapPixelShader`,o=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
