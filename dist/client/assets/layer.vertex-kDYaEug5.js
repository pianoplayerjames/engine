import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`layerVertexShader`,n=`attribute position: vec2f;uniform scale: vec2f;uniform offset: vec2f;uniform textureMatrix: mat4x4f;varying vUV: vec2f;const madd: vec2f= vec2f(0.5,0.5);
