import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`iblCdfyPixelShader`,n=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);const r={name:t,shader:n};export{r as b};