import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`backgroundFragmentDeclaration`,n=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);const r=`intersectionFunctions`,i=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);const a=`backgroundPixelShader`,o=`#ifdef TEXTURELODSUPPORT
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=o);const s={name:a,shader:o};export{s as b};