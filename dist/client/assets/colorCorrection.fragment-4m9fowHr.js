import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`colorCorrectionPixelShader`,n=`uniform sampler2D textureSampler; 
...
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);const r={name:t,shader:n};export{r as b};