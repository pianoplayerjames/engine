import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`gaussianSplattingVertexDeclaration`,n=`attribute vec2 position;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);const r=`gaussianSplattingUboDeclaration`,i=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
attribute vec2 position;`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);const a=`gaussianSplatting`,o=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*pos2d.w)*scale,pos2d.zw);}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);const s=`gaussianSplattingVertexShader`,c=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[s]||(e.ShadersStore[s]=c);const l={name:s,shader:c};export{l as b};