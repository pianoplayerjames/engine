import{b as e}from"./shaderStore-e8RCqiF-.js";const t=`intersectionFunctions`,n=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);const r=`backgroundPixelShader`,i=`#include<backgroundUboDeclaration>
